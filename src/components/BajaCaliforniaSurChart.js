...
const BajaCaliforniaSurChart = ({ data }) => {
  ...
  return (
    <div>
      ...
      <div className="button-container">
        <Link to="/estados/bajacalifornia" className="button">
          Baja California
        </Link>
        <Link to="/Inicio" className="button">
          Inicio
        </Link>
        <Link to="/estados/campeche" className="button">
          Campeche
        </Link>
      </div>
    </div>
...
export default BajaCaliforniaSurChart;
